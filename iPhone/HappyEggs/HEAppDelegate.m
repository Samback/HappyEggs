...
- (void)fillCoreDataWithBaseEggs
{
   ...
   [Egg addEggWithName:@"Add egg"
    ...
    for (int i = 1; i <= 8; i++) {
        ...
        [Egg addEggWithName:eggName background:backgroundImageName couldDelete:NO eggId:1 type:DEFAULT_EGG_TYPE orientation:UIImageOrientationUp andContext:context];
    }
